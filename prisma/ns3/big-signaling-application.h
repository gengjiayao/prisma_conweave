...
#ifndef BIGSIGNALING_GENERATOR_APPLICATION_H
#define BIGSIGNALING_GENERATOR_APPLICATION_H
 ...
 * \defgroup onoff BigSignalingGeneratorApplication
 *
 * This traffic generator follows a BigSignaling model: after Application::StartApplication
...
*/
class BigSignalingGeneratorApplication : public Application 
{
public:
  /**
  ...
  BigSignalingGeneratorApplication ();

  virtual ~BigSignalingGeneratorApplication();
...
#endif /* BIGSIGNALING_GENERATOR_APPLICATION_H */
