 ...
 */
#ifndef BIGSIGNALING_APP_HELPER_H
#define BIGSIGNALING_APP_HELPER_H
...
/**
 * \ingroup onoff
 * \brief A helper to make it easier to instantiate an ns3::BigSignalingGeneratorApplication 
 * on a set of nodes.
 */
class BigSignalingAppHelper
{
public:
  /**
   * Create an BigSignalingAppHelper to make it easier to work with BigSignalingGeneratorApplications
   *
   ...
   *        to.
   */
  BigSignalingAppHelper (std::string protocol, Address address);
   ...
   *
   * \param c NodeContainer of the set of nodes on which an BigSignalingGeneratorApplication 
   * will be installed.
  ...
  /**
   * Install an ns3::BigSignalingGeneratorApplication on the node configured with all the 
   * attributes set with SetAttribute.
   *
   * \param node The node on which an BigSignalingGeneratorApplication will be installed.
   * \returns Container of Ptr to the applications installed.
   */
   ...
   * attributes set with SetAttribute.
   *
   * \param nodeName The node on which an BigSignalingGeneratorApplication will be installed.
   * \returns Container of Ptr to the applications installed.
   */
...
#endif /* BIGSIGNALING_APP_HELPER_H */
